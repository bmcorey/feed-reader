...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
         ...
         * page?
         */
        it('the items are defined', function() {
         ...
         */
        it('URL is working and not empty', function() {
         ...
         */
        it('the name defined, displayed and they are not empty', function() {
            allFeeds.forEach(function(feed) {
    ...
    describe('The Initial Entries', function() {
